...
@section('content')
    <div class="container">
        @if (Auth::check() && Auth::user()->rol == 'admin')
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('contactos.update',$contacto->id) }}" method="post" enctype="multipart/form-data" class="col-12">
                        {!! csrf_field() !!}
                        {{ method_field('PUT') }}
                        @if ($errors->any())
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <input value="{{$contacto->titulo}}"  type="text" class="form-control" id="titulo" name="titulo">
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="correo" name="correo" value="{{$contacto->correo}}">
                            </div>
